import { SVGProps, useRef, useLayoutEffect, useEffect, useState } from "react";
...
const CircleAniSVG = (props: SVGProps<SVGSVGElement>) => {
  ...
  useEffect(() => {
    const setIntervalId = setInterval(() => {
      setActiveRandom(Math.floor(Math.random() * arrPath.length));
    }, 2000);
  ...
  const activeId = arrPath[activeRandom];
